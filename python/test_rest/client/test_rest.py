...
# https://plainenglish.io/blog/python-application-servers
# https://antisyllogism.medium.com/python-flask-tutorial-463c6b2ba1bc
# https://blog.miguelgrinberg.com/post/the-flask-mega-tutorial-part-i-hello-world
# https://www.geeksforgeeks.org/when-should-flask-g-be-used/
# https://realpython.com/python-sockets/

config_dir = 'test_rest/client/'
